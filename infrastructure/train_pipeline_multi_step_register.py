...
def create_multi_step_pipeline(
    ...
    register_step = RegisterModel(
        name="RegisterModel",
        estimator=estimator,
        # model_data: S3 URI of the model.tar.gz produced by TrainModel step
        model_data=train_step.properties.ModelArtifacts.S3ModelArtifacts,
        content_types=["text/csv"],
        response_types=["text/csv"],
        inference_instances=["ml.m5.large"],  # allowed instance types for hosting
        transform_instances=[
            "ml.m5.large"
        ],  # allowed instance types for batch transform
        model_package_group_name=MODEL_PACKAGE_GROUP_NAME,
        # Manual “gate”: model goes to registry as Pending and you approve later in console
